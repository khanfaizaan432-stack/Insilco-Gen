...
EXACT_VARIANT = "NC_000001.11:g.100A>G"
...
def clinical_payload():
    return {
        ...
        "candidate_variants": [{
            ...
            "genome_build": "GRCh38", "chromosome": "1", "position": 100, "ref": "A", "alt": "G",
        }],
...
def test_run_writes_bounded_artifact_report_trace_checksum_and_lock(tmp_path):
    ...
    assert lock["variant_intelligence_algorithm_version"] == "insilicopop-variant-intelligence-0.30.0"
